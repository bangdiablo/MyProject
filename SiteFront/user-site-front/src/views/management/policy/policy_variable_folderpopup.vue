    ...
    export default {
        ...
        methods: {
            ...
            sendFolderVariable() {
                ...
                if (this.general_modal == 'ocr_modal') {
                    EventBus.$emit('variable_ocr_folderpath', data)
                }
                if (this.general_modal == 'extension_modal') {
                    EventBus.$emit('variable_extension_folderpath', data)
                }
                if (this.general_modal == 'general_modal') {
                    EventBus.$emit('variable_general_folderpath', data)
                }
                if (this.general_modal == 'cold_modal') {
