            ...
            <table cellspacing="0" class="table_type01">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col"><a href="javascript:void(0)" class="sorting inactive">계정<span class="ico_upDown"></span></a></th>
                        <th scope="col"><a href="javascript:void(0)" class="sorting inactive">유저<span class="ico_upDown"></span></a></th>
                        <th scope="col"><a href="javascript:void(0)" class="sorting inactive">기기명<span class="ico_upDown"></span></a></th>
